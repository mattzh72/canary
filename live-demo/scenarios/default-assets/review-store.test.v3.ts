...
describe("review store", () => {
  ...
  it("sorts blocked work first and then overloaded stale review handoffs", () => {
  ...
  it("tracks mergeable, stale, overloaded reviewers, and changed file totals", () => {
    expect(
      buildReviewerSummary([
        {
          id: "a",
